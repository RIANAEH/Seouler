...
class PlaceRVAdapter(context : Context, val placelist : ArrayList<Place>) :
    ...
    inner class Holder(itemView: View?) : RecyclerView.ViewHolder(itemView!!) {
        ...
        val dest = itemView?.findViewById<TextView>(R.id.tv_dist)
        ...
        fun bind(aplace: Place, context: Context) {
